...
function ProcessingPanel({ 
  ...
  const strengthOptions = {
    ...
    advcloak: [
      ...
      { id: 'standard', name: 'Standard', epsilon: 0.05, iterations: 15, recommended: true },
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="lg:w-1/2 space-y-4">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Ready to Protect</h2>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="bg-gray-50 p-3 rounded">
                ...
                <p className="font-medium">{(image.size / 1024 / 1024).toFixed(1)} MB</p>
              </div>
            </div>
      ...
      {/* Settings */}
      <div id="protection-settings" className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 scroll-mt-20">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Protection Settings</h3>
        
        {/* Warning */}
        <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded">
          <p className="text-amber-800 text-sm">
            <strong>Experimental:</strong> These are research techniques with no guarantees of effectiveness.
          </p>
        </div>

        {/* Method Selection */}
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-3">Protection Method</label>
        ...
        {/* Strength Selection */}
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-3">Protection Strength</label>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {strengthOptions[settings.method]?.map((option) => {
              const isSelected = settings.method === 'fawkes' 
