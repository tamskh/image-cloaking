...
function App() {
  ...
  useEffect(() => {
    if (selectedImage && !results) {
      ...
      setTimeout(() => {
        const protectionSettings = document.querySelector(
          "#protection-settings",
        );
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-6">
            Research-based techniques that attempt to make photos harder for
            some AI systems to analyze. Your images stay{" "}
            <span className="text-primary-600 font-semibold">
              perfectly clear to humans
            </span>{" "}
            but may
            <span className="text-amber-600 font-semibold">
              {" "}
              confuse some AI models
            </span>{" "}
            ...
            <>
              ...
              <section id="why-section" className="scroll-mt-20">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    Every day, AI systems scan billions of photos to identify
                    people. Here's how we help you stay private.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="card text-center">
                    ...
                    <p className="text-gray-600 text-sm">
                      Platforms use AI to identify you across photos, even when
                      you're not tagged
                    </p>
                  </div>
                  ...
                  <div className="card text-center">
                    ...
                    <p className="text-gray-600 text-sm">
                      Public cameras and databases can track your movements
                  ...
                  <div className="card text-center">
                    ...
                    <p className="text-gray-600 text-sm">
                      Companies may scan public photos to research employees and
                      job candidates
                    </p>
                  </div>
                  ...
                  <div className="card text-center">
                    ...
                    <p className="text-gray-600 text-sm">
                      Companies collect and sell your facial data without your
              ...
              <section id="how-it-works-section" className="scroll-mt-20">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    We add tiny, invisible noise patterns that may interfere
                    with some AI vision systems - based on adversarial machine
                    learning research
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 mb-3">
                          Your photo looks exactly the same. No visible changes,
                          no quality loss, no weird artifacts. Anyone looking at
                          it sees a perfectly normal photo.
                        </p>
                  ...
                  <div className="card">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">
                          What Some AI May See
                        </h3>
                        <p className="text-gray-600 mb-3">
                          Some AI systems may get confused by the noise
                          patterns, but results vary greatly. Advanced or
                          updated AI systems may still analyze the image
                          successfully.
                        </p>
                  ...
                  <div className="text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center font-bold text-lg mb-3">
                          1
                        </div>
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <div className="text-xs text-gray-500 text-center">
                          We add invisible protection
                        </div>
                      </div>
                      <div className="flex flex-col items-center">
                        <div className="w-12 h-12 bg-security-100 text-security-600 rounded-full flex items-center justify-center font-bold text-lg mb-3">
                          4
                        </div>
                        <div className="text-sm font-medium text-gray-900 mb-1">
                          Download & Share
              ...
              <section id="faq-section" className="scroll-mt-20">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">
                    Everything you need to know about protecting your photos
                  </p>
                </div>
              ...
              <section>
                <div className="card text-center">
                  <h3 className="text-xl font-semibold text-gray-900 mb-6">
                    Trusted by Privacy-Conscious People Worldwide
                  </h3>
      ...
      <footer className="mt-16 py-8 border-t border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto px-4 text-center text-gray-500">
          ...
          <p className="text-sm mt-2">
            Open source • No tracking • Client-side only • Made for the public
            good
          </p>
...
function FAQItem({ question, answer }) {
  ...
  return (
    <div className="card">
      ...
      {isOpen && (
        <div className="mt-3 text-gray-600 animate-slide-down">{answer}</div>
      )}
    </div>
  );
}
